...
| --- | --- | --- | --- | --- | --- | --- | --- |
| Minerva | https://minerva-ebp.be/?language=FR (ancien domaine `minerva-ebm.be` constaté non résolutif directement) | **Arrêtée depuis juin 2026 (arrêt des financements), confirmé par Thibault le 2026-07-31.** Le site répondait encore ponctuellement lors de la vérification initiale (fiches anciennes), mais la production est terminée. Aucun flux ni newsletter de repli : **à retirer du parcours actif**, cf. « Non retenues » | — | — | — | transversal (9 thèmes, sur le corpus déjà publié avant l'arrêt) | **retirée — production arrêtée juin 2026** |
...
| SFMG (Société Française de Médecine Générale) | https://www.sfmg.fr/ | libre (newsletter gratuite ; le site a migré de `sfmg.org` vers `sfmg.fr`, un flux RSS trouvé pour l'ancien domaine n'est plus retrouvé sur le nouveau) | newsletter confirmée (bouton « S'inscrire », **inscription faite le 2026-08-01**) ; aucun flux RSS confirmé sur le domaine actuel | inconnue | inconnue | soins-premiers (transversal MG, société distincte du CMG) | chaque semaine (par newsletter) |
...
| VIDAL News | https://www.vidalfrance.com/ | libre pour les professionnels de santé (compte requis) | newsletter confirmée (**inscription faite le 2026-08-01**) ; aucun flux RSS identifié | inconnue | inconnue | transversal (pharmacovigilance, nouveaux médicaments, disponibilité — complète ANSM plutôt qu'elle ne le duplique) | chaque semaine (par newsletter) |
| DGS-Urgent | https://dgs-urgent.sante.gouv.fr/ (archives : https://sante.gouv.fr/professionnels/article/archives-dgs-urgent) | libre pour les professionnels de santé titulaires d'un n° RPPS/ADELI (inscription gratuite) | alerte e-mail via messagerie **MSSanté personnelle du référent** (confirmé le 2026-08-01 : **non routable vers la boîte de collecte dédiée** `ebmmsp@gmail.com`, MSSanté est un canal réglementé lié à l'identité professionnelle — à consulter séparément à chaque tri, hors dépouillement de la boîte mail centralisée) ; aucun flux RSS identifié | **recontrôlée en navigateur réel le 2026-07-31 : page accessible par intermittence** (chargée une fois avec le texte complet des archives, rejetée par un pare-feu applicatif — « The requested URL was rejected » — sur une tentative suivante, signe d'une protection anti-bot sensible au rythme des requêtes plutôt que d'un blocage systématique). **Constat de fond, plus important que l'accessibilité** : la page ne liste que les archives **2020 et 2021** — aucune entrée 2026 trouvée. Elle est **inexploitable pour W30/W31** (13-26 juillet 2026) en l'état ; ce n'est visiblement plus le canal d'archive courant. Un autre point d'accès aux DGS-Urgent récents reste à identifier (ou complément manuel du référent) | à l'occasion (alertes sanitaires ponctuelles, pas de calendrier fixe) | transversal (alertes sanitaires tous domaines), gratuit et actionnable par construction | chaque semaine (vérifier l'absence de nouveau message) |
...
**Total retenu : 26 sources** (8 Tier 1, 11 Tier 2, 5 Tier 3, 1 Tier 4, 1 hors-Tier de contrôle) — Minerva retirée, SFMG et VIDAL News ajoutées (inscriptions du 2026-08-01) : la fourchette 15-25 initialement visée est **dépassée de peu**. Pas un problème en soi (le rendement réel se juge à l'usage, S3/S4), mais à garder à l'œil : une liste qui continue de grossir sans qu'aucune source n'en sorte redevient une liste qu'on ne parcourt pas.
