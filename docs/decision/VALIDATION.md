# VALIDATION.md — module Décision — jugement humain en attente (N2 uniquement)

> Détail routé depuis le `VALIDATION.md` racine le 2026-09-24 (plafond racine 60 lignes) — blocs
> déplacés tels quels, rien de supprimé. Mêmes règles que la racine : N2 uniquement, un bloc par
> écran/thème courant, tout item tranché est **supprimé** (git suffit comme trace), et la ligne de
> sommaire correspondante de la racine est mise à jour. Légende : `[ ]` à valider · `[x]` OK ·
> `[!]` à corriger.
