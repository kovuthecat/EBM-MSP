...
## Résultat attendu
- R1 : le livrable signale que les seuils qui déclenchent la réduction de dose manquent dans la capture, relève l'anomalie de capture (aucun caractère « < » dans le retour) comme cause probable, et ne conclut pas qu'OE ne les donne pas — fondée sur docs/decision/validation/chantier-2026-07-29/OE-passeA-lecture-et-integrite.md:14-22 (assoupli par le référent le 2026-09-24 : une cause probable suffit, pas une certitude)
