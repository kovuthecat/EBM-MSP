...
| [S8‑ui](S8-recette-ui.md) | T‑027 | **Reprise de la recette référent** (nœud « Traiter ») : afficher les options écartées, alertes portées par une option, switch générique de la gliptine | Opus (arbitrages) + Sonnet (code) | medium | S7‑ui | `evaluateNode`, `relevance`, `optionBadges`, `DecisionNodeScreen`, `prescription.yaml` | [ ] **Document de reprise autoportant** — lot S7‑ui non commité en working tree (231 tests verts) |
